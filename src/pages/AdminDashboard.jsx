...
export default function AdminDashboard() {
  ...
  const defaultAnnouncements = [
    { text: { ar: 'توصيل مجاني للطلبات فوق 500 ج.م', en: 'Free delivery on orders over 500 EGP' }, icon: 'fa-solid fa-truck-fast' },
    { text: { ar: 'إطلاق الكوليكشن الأول من Black & White', en: 'First Collection Launch' }, icon: 'fa-solid fa-star' },
    { text: { ar: 'استبدال مجاني خلال 7 أيام', en: 'Free 7 days exchange' }, icon: 'fa-solid fa-rotate-left' },
    { text: { ar: 'مضمون 100٪ جودة أصلية', en: '100% Original Quality Guarantee' }, icon: 'fa-solid fa-shield-halved' }
  ];
              ...
              {activePanel === 'hero' && (
                <div className="panel active">
                  <div className="card">
                    ...
                    <form key={hero.updatedAt || hero._id || JSON.stringify(hero)} onSubmit={saveHero}>
              ...
              {activePanel === 'settings' && (
                <div className="panel active">
                  <div className="card">
                    ...
                    <form key={settings.updatedAt || settings._id || JSON.stringify(settings)} onSubmit={saveSettings}>
                      <div className="form-group">
